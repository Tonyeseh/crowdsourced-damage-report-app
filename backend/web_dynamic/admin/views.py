...
admin_views = Blueprint('admin_views', __name__, url_prefix='/admin', static_folder='static')
...
def admin_home(current_user):
    ...
    return render_template('admin/dashboard.html', user=current_user, page='dashboard', damage_info={"completed": len(completed_damage),
...
def get_all_locations(current_user):
    ...
    return render_template('admin/location.html', all_locations=all_locations, user=current_user, page='location')
...
def get_infrastructures(current_user):
    ...
    return render_template('admin/infrastructure.html', all_infras=all_infras, page='infras', user=current_user, locations=locations)
...
def get_facilities(current_user):
    ...
    return render_template('admin/facility.html', all_facilities=all_facilities, user=current_user, page='facility', locations=locations)
...
def get_damages(current_user):
    ...
    return render_template('admin/damage.html', all_damages=all_damages_lst, user=current_user, page='damage', )
...
def get_categories(current_user):
    ...
    return render_template('admin/category.html', categories=all_cat, user=current_user, page='category')
